<?php /* Smarty version 2.6.9, created on 2015-06-18 20:50:18
         compiled from C:%5CApache+Software+Foundation%5CApache2.2%5Chtdocs%5Cmailing_list/templates/admin/group_approval_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'C:\\Apache Software Foundation\\Apache2.2\\htdocs\\mailing_list/templates/admin/group_approval_list.tpl', 13, false),array('modifier', 'date_format', 'C:\\Apache Software Foundation\\Apache2.2\\htdocs\\mailing_list/templates/admin/group_approval_list.tpl', 89, false),)), $this); ?>
<html>
  <head>
  ...
  if (res == true) {
    document.approval_form.action = 'status.php?mode=status&approval=2&send=group_approval_list&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
';
...
/tcm-admin/delete.php?mode=sakujyo&send=group_approval_list&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&group_id=" + group_id;
  }
  }
  function sakujyo() {
  ...
  if (res == true) {
    document.approval_form.action = 'delete.php?mode=sakujyo&send=group_approval_list&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
';
    document.approval_form.submit()
  }
  }
...
?>
              <tr>
                <td><center><input type="checkbox" name="group_check[]" value=<?php echo $this->_tpl_vars['group_map']['group_id']; ?>
></center></td>
                <td><center><a href="<?php echo @URL_ROOT_HTTPS; ?>
/tcm-admin/group_member_list.php?group_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['group_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['group_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <td><center><?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['mailing_list_address'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</center></td>
                <td><center><a href="#" onclick="sakujyo_link('<?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['group_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
')">削除</a></center></td>
...
'); return false;">DL</a></center></td>
                <td><center><?php echo $this->_tpl_vars['statustypeDef_2']->getSelectTags("group_status[]",90,$this->_tpl_vars['group_map']['approval_status'],""); ?>
</center></td>
              </tr>
