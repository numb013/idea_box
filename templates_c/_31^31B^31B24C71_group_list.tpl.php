<?php /* Smarty version 2.6.9, created on 2015-06-18 20:50:14
         compiled from C:%5CApache+Software+Foundation%5CApache2.2%5Chtdocs%5Cmailing_list/templates/admin/group_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'C:\\Apache Software Foundation\\Apache2.2\\htdocs\\mailing_list/templates/admin/group_list.tpl', 14, false),array('modifier', 'date_format', 'C:\\Apache Software Foundation\\Apache2.2\\htdocs\\mailing_list/templates/admin/group_list.tpl', 96, false),)), $this); ?>
<html>
  <head>
...
&send=group_list&group_id=" + group_id;
  }
  }
  function status1() {
    res = confirm('ステータスを変更してもよろしいでしょうか？');
  if (res == true) {
    document.approval_form.action = 'status.php?mode=status&approval=1&send=group_list&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
';
  ...
  if (res == true) {
    document.approval_form.action = 'delete.php?mode=sakujyo&send=group_list&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
';
    document.approval_form.submit()
  }
  }
  function approval_all() {
    res = confirm('承認してもよろしいでしょうか？');
  if (res == true) {
    document.approval_form.action = 'approval.php?mode=select';
    document.approval_form.submit()
  }
  }
  function member_csv() {
 ...
 ?>
      ...
      <div id="bodyContainer">
        ...
        <?php if (! is_array ( $this->_tpl_vars['group_list'] )): ?>
          <p class="message">承認待ちグループはございません</p>
        <?php else: ?>
...
&approval_status=<?php echo $this->_tpl_vars['group_map']['approval_status']; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['group_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <td><center><a href="<?php echo @URL_ROOT_HTTPS; ?>
/tcm-admin/approval.php?mode=select&group_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['group_map']['group_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&number=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">承認</a></center></td>
...
'); return false;">DL</a></center></td>
  ...
  name="group_status_id[]">
          ...
          <input type="button" value="承認" onclick="approval_all()" />
