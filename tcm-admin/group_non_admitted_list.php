...
// ページングリンク
$paging_link = $util->getPagingLink($map["record_count"], $page, ADMIN_COUNT_PAGE, ADMIN_COUNT_LINK, URL_ROOT_HTTPS."/tcm-admin/group_non_admitted_list.php", "");
...
$smarty->display(TEMPLATE_DIR."/admin/group_non_admitted_list.tpl");
