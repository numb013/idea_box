  ...
  <body>
    <div id="body">
      ...
      <div id="bodyContainer">
        <h3>アイデア編集</h3>
          <form action="{$smarty.const.URL_ROOT_HTTPS}/admin/idea_edit.php" method="post">
        ...
        <p><a href="{$smarty.const.URL_ROOT_HTTPS}/admin/idea_list.php?page={$page|escape}">戻る</a></p>
      </div>
      <br>
      <br>
      <br>
