{if is_array($error_map)}
  ...
  <tr>
    <td style="background-color:#f7f7f7;">
      ...
      <img src="{$smarty.const.URL_ROOT_HTTPS}/tcm-admin/_design/images/error_arrow.gif" style="padding-left:30px; padding-right:40px; padding-top:10px; padding-bottom:10px;"/>
      </td>
