<html>
  ...
  if (res == true) {ldelim}
    location.href = "{$smarty.const.URL_ROOT_HTTPS}/tcm-admin/delete.php?mode=sakujyo&number={$page|escape}&send=group_non_admitted_list&group_id=" + group_id;
  {rdelim}
  {rdelim}
          ...
          <table class="table" width="95%">
            ...
            {foreach item="group_map" from=$group_list key=item_key}
              <tr>
                ...
                <td><center><a href="{$smarty.const.URL_ROOT_HTTPS}/tcm-admin/group_member_list.php?group_id={$group_map.group_id}&approval_status={$group_map.approval_status|escape}&number={$page|escape}">{$group_map.group_name|escape}</a></center></td>
